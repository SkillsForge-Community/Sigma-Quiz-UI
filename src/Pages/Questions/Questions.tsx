...
const inputStyles:SystemCSSProperties = {
        ...
        <Grid templateColumns='repeat(4, 1fr)'>
            <GridItem as='main' colSpan={4} p="10px">
                ...
                <Box m='40px 20px' p='20px' bg='#EDEDED' borderRadius='20px' pos='relative'>
                    ...
                    <HStack m='10px'>
                        <InputGroup>
                            <Input placeholder='Ambassadors College International Ota' fontSize={"15px"} fontFamily='Poppins' sx={inputStyles} maxW='389px' size='md' />
                            <InputRightAddon fontSize={"15px"} sx={inputStyles}><MdOutlineKeyboardArrowDown /></InputRightAddon>
                        </InputGroup>
                        <Spacer />
