          ...
          <ModalBody >
            <div className='confimation-body'>
             ...
             ( <VStack spacing={20}>
                ...
                <HStack spacing={10}>
                  <Button variant="none"  _hover={{opacity:"0.8", transitionDuration:"0.5s"}}  className='confirmation-button yes' onClick={() => setReset(true)}>Yes</Button>
                  <Button variant="none" _hover={{opacity:"0.8", transitionDuration:"0.5s"}} className='confirmation-button no' onClick={onClose}>No</Button>
                </HStack>
              </VStack>)
              :
              (<VStack spacing={5}>
                ...
                <Button variant={"none"}  _hover={{opacity:"0.8", transitionDuration:"0.5s"}} className='confirmation-button no' onClick={handleClose}>FINISH</Button>
              </VStack>)}
            </div>
          </ModalBody>
